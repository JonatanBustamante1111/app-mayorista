    ...
    <>
      <section className="flex flex-col   w-full col-span-2 ">
        ...
        <article className="flex flex-col mx-4  md:flex-row md:h-[638px] md:gap-8 md:mx-10">
          <div
            className="relative overflow-hidden w-full h-72 md:h-full flex rounded-xl md:w-1/3 mb-10"
            data-aos="fade-up"
          ...
          <div className="md:h-full md:flex  flex-col md:gap-8 md:w-1/3">
            <div
              data-aos="fade-up"
              data-aos-duration="3000"
              className="relative overflow-hidden w-full h-72 flex  rounded-xl mb-10 md:h-1/3 md:mb-0"
            >
              <img
                className="absolute top-0 left-0 w-full h-full transition-transform duration-300 transform origin-center hover:scale-110"
            ...
            <div
              data-aos="fade-up"
              data-aos-duration="3000"
              className="relative overflow-hidden  bg-cover w-full h-72 flex flex-row  rounded-xl mb-10 md:h-2/3 md:mb-0"
            >
              <img
                className="absolute top-0 left-0 w-full h-full transition-transform duration-300 transform origin-center hover:scale-110"
