...
function Footer() {
    return ( 
        ...
        <div>
        <a href="http://qr.afip.gob.ar/?qr=WFNqQ8OVggESRy2O5S33tw,," target="_F960AFIPInfo"><img className="h-[100px] w-[80px]" src={"http://www.afip.gob.ar/images/f960/DATAWEB.jpg"} alt="" /></a>
        </div>
